...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  const handlePrint = async () => {
    ...
    saveAs(contentBlob, \`Comprobantes-Cierre-\${year}-\${String(month).padStart(2, '0')}.zip\`);
  };`;
  ...
  if (startIndex === -1) console.log("startIndex not found.");
  if (endIndex === -1) console.log("endIndex not found.");
}
